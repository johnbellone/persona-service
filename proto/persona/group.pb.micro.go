...
type GroupService interface {
	...
	Get(ctx context.Context, in *GroupRequest, opts ...client.CallOption) (*Group, error)
...
func (c *groupService) Get(ctx context.Context, in *GroupRequest, opts ...client.CallOption) (*Group, error) {
...
func RegisterGroupServiceHandler(s server.Server, hdlr GroupServiceHandler, opts ...server.HandlerOption) error {
	type groupService interface {
		...
		Get(ctx context.Context, in *GroupRequest, out *Group) error
...
func (h *groupServiceHandler) Get(ctx context.Context, in *GroupRequest, out *Group) error {
