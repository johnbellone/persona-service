...
type RoleService interface {
	...
	Get(ctx context.Context, in *RoleRequest, opts ...client.CallOption) (*Role, error)
...
func (c *roleService) Get(ctx context.Context, in *RoleRequest, opts ...client.CallOption) (*Role, error) {
...
type RoleServiceHandler interface {
	...
	Get(context.Context, *RoleRequest, *Role) error
...
func RegisterRoleServiceHandler(s server.Server, hdlr RoleServiceHandler, opts ...server.HandlerOption) error {
	type roleService interface {
		...
		Get(ctx context.Context, in *RoleRequest, out *Role) error
...
func (h *roleServiceHandler) Get(ctx context.Context, in *RoleRequest, out *Role) error {
